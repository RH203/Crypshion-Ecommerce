      ...
      <div class="w-11/12 mx-auto md:w-10/12">
        <div class="flex flex-col gap-5 lg:flex-row">
                ...
                <div class="flex">
                  ...
                  <div class="text-slate-800 ms-5">
                    <div class="w-10/12 mb-1 md:w-8/12">
                      <h4 class="font-semibold text-md">{{ Str::limit($data->product->title, 60) }}
                      </h4>
                    </div>
                    ...
                    <div class="my-1 text-sm text-slate-500">Qty : <span>{{ $data->quantity }}</span> x</div>
          ...
          <div class="h-full p-4 bg-white shadow-md md:p-8 rounded-xl basis-12/12 lg:basis-4/12">
            ...
            <div class="mt-2">
              <select name="paymentMethod" id="" wire:model.live='paymentMethod' class="w-full py-2">
            ...
            <div class="mt-8">
              ...
              <a href="#" wire:click.prevent="connectWallet" id="connect" class="block py-3 font-semibold text-center text-white rounded-lg bg-primaryBg mb-2">
                Connect Wallet
              </a>
