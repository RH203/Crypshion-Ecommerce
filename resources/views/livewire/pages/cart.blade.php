                ...
                <div class="grid grid-cols-1 gap-5 lg:grid-cols-2">
                    <div class="p-8 bg-white shadow-md rounded-xl">
                        ...
                        <p class="my-2 text-lg uppercase text-slate-500"> {{ $village->name }},
                            {{ $district->name }}, {{ $regency->name }}, {{ $province->name }}, {{ $zipCode->zip_code }}
                        </p>
                    </div>
                    <div class="p-8 bg-white shadow-md rounded-xl">
            ...
            <div class="w-11/12 mx-auto md:w-10/12">
                <div class="flex flex-col gap-5 lg:flex-row">
                                ...
                                <div class="flex">
                                    ...
                                    <div class="text-slate-800 ms-5">
                                        ...
                                        <div class="my-1 text-sm text-slate-500">Qty :
                                            <span>{{ $data->quantity }}</span> x</div>
                                        <div class="md:text-xl text-md">
                                            Rp. <span
                                                class="font-semibold">{{ number_format($data->price, 0, ',', '.') }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="text-end">
                    ...
                    <div class="h-full p-4 bg-white shadow-md md:p-8 rounded-xl basis-12/12 lg:basis-4/12">
                        ...
                        <div class="mt-2">
                            <select name="paymentMethod" id="" wire:model.live='paymentMethod'
                                class="w-full py-2">
                        ...
                        <div class="mt-8">
                            @if ($paymentMethod == '1')
                                <a href=""
                                    class="block py-3 font-semibold text-center text-white rounded-lg bg-primaryBg">
                                    Check Out
                                </a>
                            @endif
                            @if ($paymentMethod == '2')
                                ...
                                <a href="#" wire:click.prevent="connectWallet" id="connect"
                                    class="block py-3 font-semibold text-center text-white rounded-lg bg-primaryBg mb-2">
                                    Connect Wallet
                                </a>
