<div class="w-10/12 mx-auto flex flex-col mb-20">
  ...
  <div class="mx-auto mt-10 h-96 w-4/5 bg-gray-300 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-40 border border-gray-100 p-7 overflow-auto">
    <!-- Chat Bubble -->
    <ul class="space-y-5">
  ...
  <div class="mx-auto mb-10 shadow-sm w-4/5">
    <form class="relative flex rounded-lg shadow-sm" wire:submit.prevent="submit">
      ...
      <div class="absolute inset-y-0 start-0 flex items-center pointer-events-none ps-4">
        <svg class="flex-shrink-0 size-4 text-gray-400 dark:text-neutral-500" xmlns="http://www.w3.org/2000/svg" width="24"
