            ...
            <div class="w-11/12 mx-auto md:w-10/12">
                <div class="flex flex-col gap-5 lg:flex-row">
                                ...
                                <div class="flex">
                                    <div class="h-full overflow-hidden rounded-lg basis-3/12 md:h-40 bg-slate-200">
                                        <img src="{{ asset('storage/' . $data->image) }}" alt=""
                                            width="w-full object-cover" class="object-cover">
                                    </div>
                    ...
                    <div class="h-full p-4 bg-white shadow-md md:p-8 rounded-xl basis-12/12 lg:basis-4/12">
                        ...
                        <div class="mt-2">
                            <select name="selectPayment" id="" wire:model.live='selectPayment'
                                class="w-full py-2">
                        ...
                        <div class="mt-8">
                            ...
                            @if ($selectPayment == 'crypto')
                                <p class="hidden" id="hide-address">
                                    <span id="address"
                                        class="w-full px-2 py-1 overflow-hidden rounded-md bg-slate-300">
                                        Test </span>
                                </p>
...
<script type="text/javascript">
    ...
    let deliveryCost = <?php echo json_encode($deliveryCost); ?>;

    // setInterval(() => {

    //   console.log(<?php echo session('total'); ?>);
    // }, 200);
    // console.log(total);
