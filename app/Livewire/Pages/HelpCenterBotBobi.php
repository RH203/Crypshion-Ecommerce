  ...
  public function modelGeminiChatBot($message)
  {
    ...
    $chat = Gemini::chat()
      ->startChat(history: [
        ...
        Content::parse(part: 'Saat ini, Crypshion mendukung metode pembayaran dengan Ewallet, Mobile Banking, dan Cryptocurrency.
      Kami terus berupaya menambahkan lebih banyak metode pembayaran untuk kenyamanan pengguna kami.', role: Role::MODEL),
      ])
    ;
